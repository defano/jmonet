 ...
 */
public abstract class Surface extends JComponent implements Scalable, Disposable, SwingSurface, ObservableSurface,
        KeyListener, MouseListener, MouseMotionListener, KeyEventDispatcher {
    ...
    public boolean dispatchKeyEvent(KeyEvent e) {
        switch (e.getID()) {
            case KeyEvent.KEY_TYPED:
                Surface.this.keyTyped(e);
                break;
            case KeyEvent.KEY_PRESSED:
                Surface.this.keyPressed(e);
                break;
            case KeyEvent.KEY_RELEASED:
                Surface.this.keyReleased(e);
                break;
        }
